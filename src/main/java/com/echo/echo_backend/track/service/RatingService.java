...
import com.echo.echo_backend.track.dto.RatingRequest;
...
public class RatingService {
    ...
    public RatingService(UserRepository userRepository, TrackRepository trackRepository, RatingRepository ratingRepository, CommentRepository commentRepository) {
    ...
    @Transactional
    public TrackInfoDto createOrUpdateRating(RatingRequest request, Long userId) {
